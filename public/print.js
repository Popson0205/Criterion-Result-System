...
const PRINCIPAL_COMMENTS = {
  90: [
    "This is an outstanding result that reflects the very best of what a Criterion Amazing College student can achieve, and I urge you to maintain this standard.",
    "Exceptional performance — this result is a testament to your hard work, discipline, and commitment to excellence, and Criterion Amazing College is proud of you.",
  ...
  <table style="border:none;margin-bottom:6px;">
    <tr>
      ...
      <td style="border:none;text-align:center;vertical-align:middle;padding:0 10px;">
        <div style="font-size:28px;font-weight:900;color:#55A845;text-transform:uppercase;letter-spacing:1px;line-height:1.1;">CRITERION AMAZING COLLEGE, OSOGBO</div>
