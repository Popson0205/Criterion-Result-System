...
<div class="letter-page">
  ...
  <div class="letterhead">
    <img src="/icons/icon-192x192.png" alt="Criterion College Logo"
    ...
    <div class="school-name-hdr">
      <h1>CRITERION COLLEGE, OSOGBO</h1>
  ...
  <div class="letter-body">
    ...
    <p>
      ...
      <strong>successfully admitted</strong> into Criterion College, Osogbo for the
  ...
  <div class="letter-body">
    <p>
      ...
      all the rules and regulations of Criterion College, Osogbo. We look forward to a productive and
      successful academic journey with your ward.
    </p>
    <p>Congratulations and welcome to the Criterion College family!</p>
  </div>
  ...
  <div class="signature-section">
    <div class="sig-block">
      ...
      <div class="sig-sub">Criterion College, Osogbo</div>
    </div>
    <div class="sig-block">
      <div class="sig-line"></div>
  ...
  <div class="letter-footer">
    Criterion College, Osogbo &nbsp;|&nbsp; +234 806 322 4872 &nbsp;|&nbsp;
